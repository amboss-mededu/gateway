...
func TestGateway(t *testing.T) {
	...
	t.Run("Response Middleware Error", func(t *testing.T) {
		...
		gateway, err := New(sources,
			WithExecutor(ExecutorFunc(func(_ *ExecutionContext) (map[string]interface{}, error) {
				return map[string]interface{}{"goodbye": "moon"}, nil
			})),
			WithMiddlewares(
				ResponseMiddleware(func(_ *ExecutionContext, _ map[string]interface{}) error {
...
`)
	...
	queryerFactory := QueryerFactory(func(_ *PlanningContext, _ string) graphql.Queryer {
...
`)
	require.NoError(t, err)
	queryerFactory := QueryerFactory(func(_ *PlanningContext, _ string) graphql.Queryer {
		return graphql.QueryerFunc(func(_ *graphql.QueryInput) (interface{}, error) {
			return map[string]interface{}{
					"foo": "foo",
					"bar": nil,
				}, graphql.ErrorList{
