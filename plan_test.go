...
// TestPlanQuery_inlineFragmentFieldsRespectParentLocationAuthToken is this
// fork's original, real-world reproduction of the bug upstream fixed in #230.
// Upstream reduced its own regression test to a minimal schema in #232; this
// keeps the full AuthToken/Mozart shape that first surfaced the problem here.
func TestPlanQuery_inlineFragmentFieldsRespectParentLocationAuthToken(t *testing.T) {
	t.Parallel()
